...
import 'package:susil/medical.dart';

class Maxio extends StatefulWidget {
  const Maxio({super.key});

  @override
  State<Maxio> createState() => _MaxioState();
}

class _MaxioState extends State<Maxio> {
  @override
